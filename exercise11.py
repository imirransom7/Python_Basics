...
def reverse_int(number: int) -> str:
    ...
    # Now, I will reverse the order of the numbers using slicing And since the elements have already been turned
    # into a string, I can use the join method to convert the list back into a string with spaces as a delimiter
